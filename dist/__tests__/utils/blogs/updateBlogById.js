...
const updateBlogById = (app, postId, blogDtoInput) => __awaiter(void 0, void 0, void 0, function* () {
    const updatedBlog = Object.assign(Object.assign({}, (0, blogDto_1.blogDto)()), blogDtoInput);
    yield (0, supertest_1.default)(app)
        .put(`${blogs_paths_1.BLOGS_PATH}/${postId}`)
