...
const getBlogDto_1 = require("./getBlogDto");
const createBlog = (app, inputForBlog) => __awaiter(void 0, void 0, void 0, function* () {
    const testBlogData = Object.assign(Object.assign({}, (0, getBlogDto_1.getBlogDto)()), inputForBlog);
